...
export default function EngineeringDashboard({ user, onLogout, onReturn }) {
  ...
  return (
    <div className="eng-dashboard">
      ...
      <header className="eng-navbar">
        <div className="eng-navbar-brand">
          <div className="eng-navbar-mark">IR</div>
          <div className="eng-navbar-titles">
            <span className="eng-navbar-title">INDIAN RAILWAYS</span>
            <span className="eng-navbar-subtitle">Engineering (Civil / Track P-Way)</span>
          </div>
        </div>

        {/* Officer Meta & Actions */}
        <div className="eng-navbar-actions">
          <div className="eng-officer-pill">
            <span className="eng-officer-name">{user?.name || 'Ramesh Kumar'}</span>
            <span className="eng-officer-dept">
              {user?.designation || 'Sr. Section Engineer (P-Way)'} ({user?.userId || 'ENG001'})
            </span>
          </div>
      ...
      <div className="eng-layout-body">
        <aside className="eng-sidebar">
          <div className="eng-sidebar-section-title">CONTROL OPERATIONS</div>
          <nav className="eng-sidebar-nav">
            <button
              type="button"
              className={`eng-sidebar-tab ${activeTab === 'home' ? 'active' : ''}`}
            ...
            <button
              type="button"
              className={`eng-sidebar-tab ${activeTab === 'tracking' ? 'active' : ''}`}
            ...
            <button
              type="button"
              className={`eng-sidebar-tab ${activeTab === 'planning' ? 'active' : ''}`}
        ...
        <div className="eng-content-canvas">
          {/* Sub-Header Banner (Only for Home tab) */}
      {activeTab === 'home' && (
        <div className="eng-header-banner">
          <div className="eng-header-title-group">
            <h1>Civil &amp; Track P-Way Station Timetable Operations</h1>
            <p>Real-time passenger &amp; freight timetable board for maintenance window scheduling</p>
          </div>

          <div className="eng-header-controls">
            <div className="eng-station-select-box">
              <MapPin size={15} color="#0284c7" />
              <label htmlFor="eng-station-dropdown">Station:</label>
              <select
                id="eng-station-dropdown"
          ...
          <div>
            ...
            {loadingTimetable ? (
              <div style={{ textAlign: 'center', padding: '40px', background: '#fff', borderRadius: '10px', border: '1px solid #e2e8f0' }}>
                <RefreshCw size={24} className="spin-animation" color="#0284c7" />
